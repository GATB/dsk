...
public:
    ...
    template<size_t span> struct Functor  {  void operator ()  (Parameter parameter)
    {
		...
		if(tool.getParser()->saw("-fastq")) fastq_output = true;
		...
		char * qualdummy;
		qualdummy = (char *) malloc(kmerSize* sizeof(char));
        ...
        for (itKmers->first(); !itKmers->isDone(); itKmers->next())
        {
			...
			{
				output << "@\n";
				output << model.toString(count.value)<< "\n";
				output << "+\n";
				output.write(qualdummy,kmerSize);
				output << "\n";
			}
			else
			{
